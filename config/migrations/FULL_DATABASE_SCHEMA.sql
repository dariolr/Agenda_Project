...
CREATE TABLE `business_invitations` (
  ...
  `role` enum('admin','manager','staff','viewer','custom') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'staff',
  ...
  `allowed_staff_ids` json DEFAULT NULL,
  `can_manage_bookings` tinyint(1) DEFAULT NULL,
  `can_manage_clients` tinyint(1) DEFAULT NULL,
  `can_manage_services` tinyint(1) DEFAULT NULL,
  `can_manage_staff` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `business_users` (
  ...
  `business_id` int UNSIGNED NOT NULL,
  `user_id` int UNSIGNED NOT NULL,
  `role` enum('owner','admin','manager','staff','viewer','custom') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'staff',
  `scope_type` enum('business','locations') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'business',
  `staff_id` int UNSIGNED DEFAULT NULL,
  ...
  `allowed_staff_ids` json DEFAULT NULL COMMENT 'NULL = nessun filtro. Array di staff_id: operatore opera solo su quei membri del team.',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `locations` (
  ...
  `phone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notification_emails` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Email notifiche prenotazioni (separate da virgola)',
  ...
  `booking_intro_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Messaggio opzionale mostrato nel booking online dopo la scelta sede e prima della selezione servizi/lezioni',
  `booking_confirmation_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Messaggio opzionale mostrato nel booking online nella pagina di conferma prenotazione',
...
CREATE TABLE `notification_queue` (
  ...
  `class_booking_id` int UNSIGNED DEFAULT NULL COMMENT 'Reference to related class booking',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `whatsapp_business_config` (
  ...
  `is_default` tinyint(1) NOT NULL DEFAULT '0',
  `template_auto_submit_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `template_default_language` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'it',
  `template_default_category` enum('marketing','utility','authentication','service') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'utility',
...
--
-- Struttura della tabella `booking_payment_lines`
--
