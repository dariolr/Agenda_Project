...
### Migration
Inclusa in: `config/migrations/FULL_DATABASE_SCHEMA.sql` (sezione BUSINESS USERS)
...
bin/
├── job-notification.php
└── job-queue-reminders.php
...
- Migrazione: `config/migrations/0040_add_viewer_role.sql`.
...
- `config/migrations/0043_business_invitations_add_staff_id.sql`
