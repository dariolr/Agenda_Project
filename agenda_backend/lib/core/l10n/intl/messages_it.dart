...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(url) =>
      "Il cliente potrà prenotare solo questo evento.\n\n${url}";

  static String m7(url) =>
      "Il cliente potrà prenotare solo questo pacchetto.\n\n${url}";

  static String m8(url) =>
      "Il cliente potrà prenotare solo questo servizio.\n\n${url}";

  static String m9(url) =>
      "Il cliente potrà prenotare solo con questo membro dello staff.\n\n${url}";

  static String m10(fields, rules) => "${fields} campi · ${rules} regole";

  static String m11(appointment, location) =>
      "Tutte le prenotazioni per ${appointment} nella sede ${location}";

  static String m12(appointment) => "Tutte le prenotazioni per ${appointment}";

  static String m13(category, location) =>
      "Tutte le prenotazioni della categoria ${category} nella sede ${location}";

  static String m14(category) =>
      "Tutte le prenotazioni della categoria ${category}";

  static String m15(location) => "Tutte le prenotazioni della sede ${location}";

  static String m16(count) => "${count} selezionati";

  static String m17(fields) => "Campi modificati: ${fields}";

  static String m18(type) => "Inviata email di tipo: ${type}";

  static String m19(type) => "Email non inviata di tipo: ${type}";

  static String m20(channel) => "Tipo: ${channel}";

  static String m21(email) => "Destinatario: ${email}";

  static String m22(dateTime) => "Data invio: ${dateTime}";

  static String m23(reason) => "Motivo: ${reason}";

  static String m24(dateTime) => "Scartata il: ${dateTime}";

  static String m25(subject) => "Oggetto: ${subject}";

  static String m26(url) =>
      "Il cliente aprirà la prenotazione già filtrata su questa sede.\n\n${url}";

  static String m27(count) => "${count} notifiche";

  static String m28(date, time, staffName) =>
      "La prenotazione verrà spostata al ${date} alle ${time} per ${staffName}.";

  static String m29(duration) => "Durata totale: ${duration}";

  static String m30(price) => "Totale: ${price}";

  static String m31(count) => "${count} prenotazioni";

  static String m32(count, percent, periodTotal) =>
      "${count} prenotazioni (${percent}% di ${periodTotal})";

  static String m33(confirmed, capacity, waitlist) =>
      "Confermati: ${confirmed}/${capacity} • Lista attesa: ${waitlist}";

  static String m34(confirmed, capacity) =>
      "Confermati: ${confirmed}/${capacity}";

  static String m35(customerId) => "Cliente ${customerId}";

  static String m36(createdCount) => "Programmazioni create: ${createdCount}.";

  static String m37(createdCount, skippedCount) =>
      "Programmazioni create: ${createdCount}. Saltate: ${skippedCount}.";

  static String m38(count) => "Crea ${count} programmazioni";

  static String m39(staffId) => "Staff non attivo (ID: ${staffId})";

  static String m40(clientName) => "Appuntamenti di ${clientName}";
  ...
  static String m46(location) => "Tutti i clienti della sede ${location}";

  static String m47(hours) => "${hours} ora";

  static String m48(hours, minutes) => "${hours} ora ${minutes} min";

  static String m49(minutes) => "${minutes} min";

  static String m50(id) => "Eccezione non trovata: ${id}";

  static String m51(factor) => "Nessun builder disponibile per ${factor}";

  static String m52(path) => "Pagina non trovata: ${path}";

  static String m53(count) =>
      "${count} ${Intl.plural(count, one: 'giorno', other: 'giorni')}";

  static String m54(dates) => "Alcuni giorni non sono stati salvati: ${dates}.";

  static String m55(details) =>
      "Alcuni giorni non sono stati salvati: ${details}.";

  static String m56(hours) => "${hours}h";

  static String m57(hours, minutes) => "${hours}h ${minutes}m";

  static String m58(businessName, role) =>
      "Sei stato invitato a collaborare con ${businessName} come ${role}.";

  static String m59(date) => "Ultima visita: ${date}";

  static String m60(newTime, staffName) =>
      "L\'appuntamento verrà spostato alle ${newTime} per ${staffName}.";

  static String m61(date) => "Accettato il ${date}";

  static String m62(email) =>
      "Vuoi eliminare definitivamente l\'invito per ${email}?";

  static String m63(date) => "Scade il ${date}";

  static String m64(email) => "Invito inviato a ${email}";

  static String m65(name) => "Invitato da ${name}";

  static String m66(count) => "${count} inviti archiviati";

  static String m67(count) => "${count} inviti in attesa";

  static String m68(name) => "Vuoi rimuovere ${name} dal team?";

  static String m69(email) => "Vuoi revocare l\'invito per ${email}?";

  static String m70(name) => "Vuoi eliminare \"${name}\"?";

  static String m71(durationA, durationB, totalDuration) =>
      "Sett. A: ${durationA} | Sett. B: ${durationB} | Tot: ${totalDuration}";

  static String m72(hoursA, hoursB, total) =>
      "Sett. A: ${hoursA}h | Sett. B: ${hoursB}h | Tot: ${total}h";

  static String m73(week) => "Settimana attuale: ${week}";

  static String m74(count) => "Mostra planning scaduti (${count})";

  static String m75(from) => "Valida dal ${from}";

  static String m76(from, to) => "Valida dal ${from} al ${to}";

  static String m77(from) => "Dal ${from}";

  static String m78(from, to) => "Dal ${from} al ${to}";

  static String m79(duration) => "${duration}/settimana";

  static String m80(hours) => "${hours}h/settimana";

  static String m81(count) => "Crea ${count} appuntamenti";

  static String m82(count) => "${count} conflitti";

  static String m83(count) => "${count} appuntamenti";

  static String m84(count) => "${count} selezionati";

  static String m85(index, total) => "${index} di ${total}";

  static String m86(count) => "${count} appuntamenti creati";

  static String m87(count) => "${count} saltati per conflitto";

  static String m88(index, total) =>
      "Questo è l\'appuntamento ${index} di ${total} nella serie.";

  static String m89(index, total) =>
      "Questo è l\'appuntamento ${index} di ${total} nella serie.";

  static String m90(count) => "${count} servizi";

  static String m91(count) => "${count} membri abilitati";

  static String m92(count, total) => "${count} di ${total} sedi";
  ...
  static String m95(date) => "Elimina solo la fascia oraria di ${date}";

  static String m96(dayName) =>
      "Modifica la fascia oraria settimanale di ogni ${dayName}";

  static String m97(date) => "Modifica solo la fascia oraria di ${date}";

  static String m98(count) => "${count} servizi abilitati";

  static String m99(value) => "Usa policy del business (${value})";
  ...
  static String m103(count) => "Deve contenere \"${count}\".";

  static String m104(value) => "Default: ${value}.";

  static String m105(selected, total) => "${selected} su ${total}";

  static String m106(hours) => "${hours} ore totale";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "agendaDisplaySettingsMobileColumnsLabel":
        MessageLookupByLibrary.simpleMessage(
          "Colonne visibili contemporaneamente",
        ),
    ...
    "apiErrorClassTypeNameExists": MessageLookupByLibrary.simpleMessage(
      "Esiste già un tipo evento con questo nome.",
    ),
    ...
    "billingCurrentPeriodEndCancellationLabel":
        MessageLookupByLibrary.simpleMessage("Scade il"),
    ...
    "billingNotRequiredTitle": MessageLookupByLibrary.simpleMessage(
      "Nessuna fatturazione richiesta",
    ),
    "billingNotesLabel": MessageLookupByLibrary.simpleMessage("Note"),
    ...
    "billingStatusActive": MessageLookupByLibrary.simpleMessage("Attivo"),
    "billingStatusCanceled": MessageLookupByLibrary.simpleMessage("Cancellato"),
    "billingStatusCancellationScheduled": MessageLookupByLibrary.simpleMessage(
      "Annullamento programmato",
    ),
    "billingStatusError": MessageLookupByLibrary.simpleMessage("Errore"),
    "billingStatusFieldLabel": MessageLookupByLibrary.simpleMessage("status"),
    "billingStatusInactive": MessageLookupByLibrary.simpleMessage("Non attivo"),
    "billingStatusLabel": MessageLookupByLibrary.simpleMessage("Stato"),
    ...
    "billingTitle": MessageLookupByLibrary.simpleMessage("Abbonamento"),
    ...
    "bookingDirectLinkBusinessScopeAction":
        MessageLookupByLibrary.simpleMessage("Link unico business"),
    ...
    "bookingDirectLinkCopyBusinessCategoryAction":
        MessageLookupByLibrary.simpleMessage("Copia link categoria business"),
    "bookingDirectLinkCopyStaffAction": MessageLookupByLibrary.simpleMessage(
      "Copia link prenotazione staff",
    ),
    "bookingDirectLinkLocationChoiceTitle":
        MessageLookupByLibrary.simpleMessage("Scegli la sede"),
    "bookingDirectLinkLocationScopeAction":
        MessageLookupByLibrary.simpleMessage("Link per sede specifica"),
    "bookingDirectLinkNoCompatibleLocationsMessage":
        MessageLookupByLibrary.simpleMessage(
          "Non ci sono sedi online compatibili con questo link.",
        ),
    "bookingDirectLinkScopeChoiceTitle": MessageLookupByLibrary.simpleMessage(
      "Scegli il tipo di link",
    ),
    ...
    "bookingFormsNoRulesHint": MessageLookupByLibrary.simpleMessage(
      "Senza condizioni il modulo non comparirà mai online.",
    ),
    ...
    "bookingFormsRuleAdd": MessageLookupByLibrary.simpleMessage(
      "Aggiungi condizione",
    ),
    ...
    "bookingFormsRuleConfirm": MessageLookupByLibrary.simpleMessage("Conferma"),
    "bookingFormsRuleLessonsSection": MessageLookupByLibrary.simpleMessage(
      "Lezioni",
    ),
    ...
    "bookingFormsRuleOtherServices": MessageLookupByLibrary.simpleMessage(
      "Altri servizi",
    ),
    "bookingFormsRulePackagesSection": MessageLookupByLibrary.simpleMessage(
      "Pacchetti",
    ),
    "bookingFormsRuleRefine": MessageLookupByLibrary.simpleMessage(
      "Limita a (facoltativo)",
    ),
    ...
    "bookingFormsRuleScopeQuestion": MessageLookupByLibrary.simpleMessage(
      "Quando mostrare il modulo?",
    ),
    "bookingFormsRuleSearchHint": MessageLookupByLibrary.simpleMessage(
      "Cerca…",
    ),
    "bookingFormsRuleSelectAll": MessageLookupByLibrary.simpleMessage(
      "Seleziona tutto",
    ),
    ...
    "bookingFormsRuleSelectedCount": m16,
    "bookingFormsRulesGuide": MessageLookupByLibrary.simpleMessage(
      "Ogni condizione indica quando mostrare il modulo. Puoi aggiungere più condizioni: il modulo appare se almeno una è soddisfatta.",
    ),
    ...
    "bookingFormsWarningNoRules": MessageLookupByLibrary.simpleMessage(
      "Non hai indicato quando mostrarlo",
    ),
    ...
    "bookingHistoryChangedFields": m17,
    ...
    "bookingHistoryEventNotificationSentTitle": m18,
    "bookingHistoryEventNotificationSkippedTitle": m19,
    ...
    "bookingHistoryNotificationChannel": m20,
    ...
    "bookingHistoryNotificationRecipient": m21,
    "bookingHistoryNotificationSentAt": m22,
    "bookingHistoryNotificationSkipReason": m23,
    "bookingHistoryNotificationSkippedAt": m24,
    "bookingHistoryNotificationSubject": m25,
    ...
    "bookingLinkOpenAction": MessageLookupByLibrary.simpleMessage("Apri link"),
    "bookingLocationLinkCopiedMessage": m26,
    "bookingLocationLinkCopyAction": MessageLookupByLibrary.simpleMessage(
      "Copia link sede",
    ),
    "bookingLocationLinkMissingBusinessSlugMessage":
        MessageLookupByLibrary.simpleMessage(
          "Impossibile creare il link: slug business non disponibile.",
        ),
    ...
    "bookingNotificationsTotalCount": m27,
    ...
    "bookingRescheduleConfirmMessage": m28,
    ...
    "bookingTotalDuration": m29,
    "bookingTotalPrice": m30,
    ...
    "bookingsListTotalCount": m31,
    "bookingsListTotalWithPeriod": m32,
    ...
    "classEventsCapacitySummary": m33,
    "classEventsCapacitySummaryNoWaitlist": m34,
    ...
    "classEventsFieldPrice": MessageLookupByLibrary.simpleMessage("Prezzo"),
    "classEventsFieldPriceFreeHint": MessageLookupByLibrary.simpleMessage(
      "Lascia vuoto per gratuito",
    ),
    ...
    "classEventsFutureBadge": MessageLookupByLibrary.simpleMessage(
      "In programma",
    ),
    ...
    "classEventsParticipantCustomer": m35,
    ...
    "classEventsRecurrenceCreateSummary": m36,
    "classEventsRecurrenceCreateSummaryWithSkipped": m37,
    "classEventsRecurrencePreviewConfirm": m38,
    ...
    "classEventsStaffInactiveOption": m39,
    ...
    "classTypesDeleteHasFutureEventsMessage": MessageLookupByLibrary.simpleMessage(
      "Esistono programmazioni future associate a questo tipo evento. Elimina o annulla le programmazioni prima di procedere.",
    ),
    "classTypesDeleteHasFutureEventsTitle":
        MessageLookupByLibrary.simpleMessage("Impossibile eliminare"),
    ...
    "closuresImportHolidaysAction": m42,
    "closuresImportHolidaysAlreadyAdded": m43,
    "closuresImportHolidaysCopyLinkAction":
        MessageLookupByLibrary.simpleMessage("Copia link prenotazione"),
    ...
    "closuresImportHolidaysSuccess": m44,
    ...
    "customerFormsActiveHint": MessageLookupByLibrary.simpleMessage(
      "I moduli non attivi non vengono mai chiesti.",
    ),
    "customerFormsAdminDescription": MessageLookupByLibrary.simpleMessage(
      "Raccogli informazioni e consensi dal cliente una volta sola, alla registrazione o alla prima prenotazione",
    ),
    "customerFormsAdminTitle": MessageLookupByLibrary.simpleMessage(
      "Moduli cliente",
    ),
    "customerFormsAllClientsHint": MessageLookupByLibrary.simpleMessage(
      "Verrà chiesto a tutti i clienti.",
    ),
    "customerFormsDeleteMessage": MessageLookupByLibrary.simpleMessage(
      "Il modulo non sarà più chiesto ai clienti. Le risposte già raccolte restano nello storico.",
    ),
    "customerFormsEditorSubtitle": MessageLookupByLibrary.simpleMessage(
      "Configura il modulo, i suoi campi e quando chiederlo al cliente.",
    ),
    "customerFormsRuleBusiness": MessageLookupByLibrary.simpleMessage(
      "Tutti i clienti",
    ),
    "customerFormsRuleLocationOnly": m46,
    "customerFormsRulesGuide": MessageLookupByLibrary.simpleMessage(
      "Ogni condizione indica a chi chiedere il modulo. Puoi aggiungere più condizioni: il modulo viene chiesto se almeno una è soddisfatta.",
    ),
    "customerFormsRulesTitle": MessageLookupByLibrary.simpleMessage(
      "Quando chiederlo",
    ),
    "customerFormsStatusHidden": MessageLookupByLibrary.simpleMessage(
      "Non attivo per i clienti",
    ),
    "customerFormsStatusShown": MessageLookupByLibrary.simpleMessage(
      "Attivo per i clienti",
    ),
    "customerFormsWontShowSummary": MessageLookupByLibrary.simpleMessage(
      "Non verrà mai chiesto",
    ),
    ...
    "errorExceptionNotFound": m50,
    "errorFormFactorBuilderMissing": m51,
    ...
    "exceptionPartialSaveInfo": m54,
    "exceptionPartialSaveInfoDetailed": m55,
    ...
    "locationShowDurationToCustomerHint": MessageLookupByLibrary.simpleMessage(
      "Se attivo, la durata viene mostrata durante la prenotazione online e nell\'elenco delle prenotazioni",
    ),
    "locationShowDurationToCustomerLabel": MessageLookupByLibrary.simpleMessage(
      "Mostra durata al cliente",
    ),
    "locationShowPriceToCustomerHint": MessageLookupByLibrary.simpleMessage(
      "Se attivo, il prezzo viene mostrato durante la prenotazione online e nell\'elenco delle prenotazioni",
    ),
    "locationShowPriceToCustomerLabel": MessageLookupByLibrary.simpleMessage(
      "Mostra prezzo al cliente",
    ),
    ...
    "moreAppointmentTypesDescription": MessageLookupByLibrary.simpleMessage(
      "Gestisci servizi, eventi, categorie e listini",
    ),
    ...
    "moreWhatsappBusinessGuidePlaceholderBody":
        MessageLookupByLibrary.simpleMessage(
          "Qui verrà mostrata la guida operativa passo-passo per attivare la messaggistica WhatsApp.",
        ),
    "moreWhatsappBusinessGuidePlaceholderTitle":
        MessageLookupByLibrary.simpleMessage("Guida configurazione"),
    "moreWhatsappBusinessTitle": MessageLookupByLibrary.simpleMessage(
      "WhatsApp Business",
    ),
    "moveAppointmentConfirmMessage": m60,
    ...
    "onlineBookingVisibilityDirectLinkOption":
        MessageLookupByLibrary.simpleMessage("Solo tramite link diretto"),
    ...
    "operatorsDeleteInviteConfirm": m62,
    ...
    "operatorsRevokeInviteConfirm": m69,
    ...
    "paymentMethodsAdd": MessageLookupByLibrary.simpleMessage(
      "Aggiungi metodo",
    ),
    "paymentMethodsDeleteMessage": m70,
    ...
    "paymentMethodsDescription": MessageLookupByLibrary.simpleMessage(
      "Gestisci le tipologie di pagamento del business",
    ),
    "paymentMethodsEdit": MessageLookupByLibrary.simpleMessage(
      "Modifica metodo",
    ),
    ...
    "planningBiweeklyDuration": m71,
    "planningBiweeklyHours": m72,
    "planningCreateTitle": MessageLookupByLibrary.simpleMessage(
      "Nuovo planning",
    ),
    "planningCurrentWeek": m73,
    ...
    "planningValidFromOnly": m75,
    "planningValidFromTo": m76,
    "planningValidTo": MessageLookupByLibrary.simpleMessage(
      "Data fine validità",
    ),
    "planningValidityFrom": m77,
    "planningValidityRange": m78,
    ...
    "planningWeeklyDuration": m79,
    "planningWeeklyHours": m80,
    ...
    "reportsColRevenue": MessageLookupByLibrary.simpleMessage("Importo"),
    ...
    "resourceServiceCountPlural": m90,
    ...
    "teamLocationCancellationHoursUseBusinessWithValue": m99,
    ...
    "teamLocationNomenclatureCountPlaceholderNote": m103,
    "teamLocationNomenclatureDefaultValue": m104,
    ...
    "teamSelectedServicesCount": m105,
    ...
    "whatsappEmbeddedSignupDisplayPhone": MessageLookupByLibrary.simpleMessage(
      "Numero visualizzato (+39...)",
    ),
    "whatsappEmbeddedSignupHint": MessageLookupByLibrary.simpleMessage(
      "Inserisci il code restituito dal flusso Embedded Signup. Gli altri campi sono opzionali e aiutano il match iniziale.",
    ),
    ...
    "whatsappFieldStatus": MessageLookupByLibrary.simpleMessage("Stato"),
    ...
    "whatsappLastUpdate": MessageLookupByLibrary.simpleMessage(
    ...
    "whatsappOutboxRead": MessageLookupByLibrary.simpleMessage("Letto"),
    ...
    "whatsappQueueTest": MessageLookupByLibrary.simpleMessage("Accoda test"),
    ...
    "whatsappStatusActive": MessageLookupByLibrary.simpleMessage("Attiva"),
    ...
    "whatsappTemplateGlobalHelper": MessageLookupByLibrary.simpleMessage(
      "Rende il template disponibile come fallback per tutti i business.",
    ),
    ...
    "whatsappUnassigned": MessageLookupByLibrary.simpleMessage(
