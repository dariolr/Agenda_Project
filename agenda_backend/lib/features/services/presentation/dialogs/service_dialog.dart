...
Future<void> showServiceDialog(
  ...
  final validCategoryIds = categories.map((category) => category.id).toSet();
  ...
  if (selectedCategory != null &&
      !validCategoryIds.contains(selectedCategory)) {
    selectedCategory = null;
  }
  if (!isEditing && selectedCategory == null && categories.length == 1) {
  ...
  final businessPaletteSetting = ref
      ...
      .serviceColorPalette;
  final palette = <Color>[
    ...serviceColorPaletteForSetting(businessPaletteSetting),
  ];
  final seen = <int>{};
