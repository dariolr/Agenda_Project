...
final class ClientRepository
{
    ...
    public function findById(int $clientId): ?array
    {
        $stmt = $this->db->getPdo()->prepare(
            'SELECT id, business_id, user_id, first_name, last_name, email, phone, 
                    notes, color_hex, is_archived, blocked, created_at, updated_at
             FROM clients
    ...
    public function findByEmail(string $email, int $businessId): ?array
    {
        $stmt = $this->db->getPdo()->prepare(
            'SELECT id, business_id, user_id, first_name, last_name, email, phone, 
                    password_hash, notes, color_hex, is_archived, blocked, created_at, updated_at
             FROM clients
    ...
    public function update(int $clientId, array $data): bool
    {
        ...
        foreach (['first_name', 'last_name', 'email', 'phone', 'notes', 'color_hex', 'blocked'] as $field) {
