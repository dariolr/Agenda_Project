...
- `scripts/demo/prepare_demo.sh`  
  Applica schema DB demo (`migrations/FULL_DATABASE_SCHEMA.sql`).
- `scripts/demo/seed_demo.sh`  
  Applica seed demo (`migrations/seed_data.sql`, se presente).
- `scripts/demo/reset_demo.sh`  
...
Matrice aggiornata: `docs/demo-policy-matrix.md`.
