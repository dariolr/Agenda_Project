...
import 'package:agenda_frontend/core/widgets/desktop_popup_container.dart';
import 'package:agenda_frontend/features/agenda/domain/staff_filter_mode.dart';
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            children: [
              CircleAvatar(
                radius: 14,
                backgroundColor: widget.staff.color.withOpacity(0.2),
                child: Text(
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: CircleAvatar(
        radius: 16,
        backgroundColor: staff.color.withOpacity(0.2),
        child: Text(
